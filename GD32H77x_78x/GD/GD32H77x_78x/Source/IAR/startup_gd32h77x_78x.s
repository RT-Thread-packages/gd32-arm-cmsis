...
;               /* external interrupts handler */
                ...
                DCD     VOVD_VUVD_FILTER_IRQHandler                  ; 235:VOVD / VUVD interrupt after digital filtering
                DCD     0                                            ; 236:Reserved
...
WWDGT_IRQHandler
        ...
        PUBWEAK VAVD_LVD_VOVD_VUVD_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
VAVD_LVD_VOVD_VUVD_IRQHandler
        B VAVD_LVD_VOVD_VUVD_IRQHandler
...
DMA0_Channel6_IRQHandler
        ...
        PUBWEAK ADC0_1_RDCM_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
ADC0_1_RDCM_IRQHandler
        B ADC0_1_RDCM_IRQHandler
...
DMAMUX_OVR_IRQHandler
        ...
        PUBWEAK HPDF_INT4_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
HPDF_INT4_IRQHandler
        B HPDF_INT4_IRQHandler
...
ESC_SYNC0_IRQHandler
        ...
        PUBWEAK ESC_SYNC1_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
ESC_SYNC1_IRQHandler
        B ESC_SYNC1_IRQHandler

        PUBWEAK ESC_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
ESC_IRQHandler
        B ESC_IRQHandler
...
TIMER31_DEC_IRQHandler
        ...
        PUBWEAK CPU_DCACHE_ERR_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
CPU_DCACHE_ERR_IRQHandler
        B CPU_DCACHE_ERR_IRQHandler

        PUBWEAK CPU_ICACHE_ERR_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
CPU_ICACHE_ERR_IRQHandler
        B CPU_ICACHE_ERR_IRQHandler

        PUBWEAK VOVD_VUVD_FILTER_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
VOVD_VUVD_FILTER_IRQHandler
        B VOVD_VUVD_FILTER_IRQHandler

        PUBWEAK TIMER0_Channel_BRK_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
TIMER0_Channel_BRK_IRQHandler
        B TIMER0_Channel_BRK_IRQHandler

        PUBWEAK TIMER7_Channel_BRK_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
TIMER7_Channel_BRK_IRQHandler
        B TIMER7_Channel_BRK_IRQHandler
...
PKCAU_IRQHandler
        ...
        PUBWEAK ESC_BRIDGE_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
ESC_BRIDGE_IRQHandler
        B ESC_BRIDGE_IRQHandler

        PUBWEAK EDIM_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
EDIM_IRQHandler
        B EDIM_IRQHandler
