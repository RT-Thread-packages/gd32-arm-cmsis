...
/* GD32E51x firmware library version number V1.0 */
#define __GD32E51X_STDPERIPH_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __GD32E51X_STDPERIPH_VERSION_SUB1   (0x02) /*!< [23:16] sub1 version */
#define __GD32E51X_STDPERIPH_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __GD32E51X_STDPERIPH_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __GD32E51X_STDPERIPH_VERSION        ((__GD32E51X_STDPERIPH_VERSION_MAIN << 24)\
                                            |(__GD32E51X_STDPERIPH_VERSION_SUB1 << 16)\
                                            |(__GD32E51X_STDPERIPH_VERSION_SUB2 << 8)\
                                            |(__GD32E51X_STDPERIPH_VERSION_RC))
...
typedef enum IRQn
{
    ...
    TIMER0_BRK_TIMER8_IRQn       = 24,     /*!< TIMER0 break and TIMER8 and TIMER14 interrupt */
    TIMER0_UP_TIMER9_IRQn        = 25,     /*!< TIMER0 update and TIMER9 and TIMER15 interrupt */
    TIMER0_TRG_CMT_TIMER10_IRQn  = 26,     /*!< TIMER0 trigger and commutation and TIMER10 and TIMER16 interrupt */
    ...
    EXTI5_9_IRQn                         = 23,     /*!< EXTI[9:5] interrupts */
    TIMER0_BRK_TIMER8_TIMER14_IRQn       = 24,     /*!< TIMER0 break and TIMER8 and TIMER14 interrupt */
    TIMER0_UP_TIMER9_TIMER15_IRQn        = 25,     /*!< TIMER0 update and TIMER9 and TIMER15 interrupt */
    TIMER0_TRG_CMT_TIMER10_TIMER16_IRQn  = 26,     /*!< TIMER0 trigger and commutation and TIMER10 and TIMER16 interrupt */
    TIMER0_Channel_IRQn                  = 27,     /*!< TIMER0 channel capture compare interrupt */
    TIMER1_IRQn                          = 28,     /*!< TIMER1 interrupt */
    TIMER2_IRQn                          = 29,     /*!< TIMER2 interrupt */
    TIMER3_IRQn                          = 30,     /*!< TIMER3 interrupt */
...
#define DAC1_BASE             (APB1_BUS_BASE + 0x0000D000U) /*!< DAC1 base address */
